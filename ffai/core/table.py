...
class OutcomeType(Enum):
    ...
    TEAM_MATE_THROWN = 165 
    TEAM_MATE_FUMBLED = 166 
    RIGHT_STUFF_LANDING_SUCCESS = 167
    RIGHT_STUFF_LANDING_FAILURE = 168 
    THROWN_TEAM_MATE_SCATTER = 169 
    THROWN_TEAM_MATE_OUT_OF_BOUNDS = 169 
    THROWN_TEAM_MATE_HIT_PLAYER = 170 
    
    ALWAYS_HUNGRY_SUCCESS = 171
    ALWAYS_HUNGRY_FAILURE = 172
    ESCAPED_BEING_EATEN = 173
    EATEN_BY_TEAM_MATE = 174 
