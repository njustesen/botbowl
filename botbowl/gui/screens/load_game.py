"""
Load Game screen — lists saved games with load/delete actions.
"""
from __future__ import annotations
import pygame

from botbowl.gui.gui import SCREEN_W, SCREEN_H
from botbowl.gui.save_load import list_saves, load_game, delete_save
...
HEADER_H = 70
PADDING = 20
SECTION_TOP = HEADER_H + PADDING  # y where section header is drawn
...
class LoadGameScreen:
    """Lists saved games with Load and Delete actions."""
    ...
    def _build_rows(self):
        ...
        for name in self._saves:
            load_btn = Button(
                ...
                label='Load', font_size=12, bg_image=get_button_image('green'))
            del_btn = Button(
    ...
    def draw(self, surface: pygame.Surface):
        ...
        # Page title
        title = _fancy(24, bold=True).render('Load Game', True, (210, 215, 245))
        ...
        # Section header
        hdr = _fancy(13, bold=True).render('Saved Games', True, (155, 160, 200))
        ...
        if not self._saves:
            empty = _font(12).render('No saved games found.', True, COLOR_TEXT_DIM)
