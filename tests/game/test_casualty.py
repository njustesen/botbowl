...
def test_casualty():
    ...
    assert defender.state.casualty_effects[0] is CasualtyEffect.MNG
...
def test_casualty_regeneration_success():
    ...
    assert len(defender.state.casualty_effects) == 0
...
def test_casualty_with_decay():
    ...
    assert defender.state.casualty_effects[1] is CasualtyEffect.NONE
...
def test_casualty_with_decay_mng_twice_is_just_one():
    ...
    assert defender.state.casualty_effects[0] is CasualtyEffect.MNG
    assert game.has_report_of_type(OutcomeType.MISS_NEXT_GAME)
    assert len(defender.state.casualty_effects) == 1
...
def test_casualty_regeneration_failure():
    ...
    assert len(defender.state.casualty_effects) == 2
