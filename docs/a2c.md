...
The code presented in this tutorial is based on [examples/a2c/a2c.py](examples/a2c/a2c.py) which is inspired by a [pytorch implementation 
...
Take a look for yourself at the remaining code in [examples/a2c/a2c.py](examples/a2c/a2c.py) to understand how the learning works. 
